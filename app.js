...
(function() {
  var RestController, app, docs_handler, express, http, path, pet, petModel, petResources, routes, swagger, url, user;
  ...
  swagger.addModels(petModel).addGet(petResources.getPet).addGet(petResources.getPets).addPost(petResources.postPet).addPut(petResources.putPet).addDelete(petResources.deletePet);
